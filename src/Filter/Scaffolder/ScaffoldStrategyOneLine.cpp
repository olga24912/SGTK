...
namespace filter {
    namespace scaffolder {
        ...
        void ScaffoldStrategyOneLine::addConnection(Scaffolds *scaffolds, ContigGraph *graph) {
            topSort(graph);
            findCycle(graph);
        ...
        void ScaffoldStrategyOneLine::addFirstConnection(Scaffolds *scaffolds, ContigGraph *graph) {
        ...
        void ScaffoldStrategyOneLine::delEdgeFromDifPath(Scaffolds *scaffolds, ContigGraph *graph) {
